...
const authConfig = {
    providers: [
        CredentialsProvider({
            ...
            credentials: {
                username: {label: "Benutzername", type: "text", placeholder: "max.muster"},
            ...
            async authorize(credentials) {
                ...
                const ldapUser = await authenticateUser(credentials.username as string, credentials.password as string);
